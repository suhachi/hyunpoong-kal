...
Complete source code of main entry points and routing configuration.
...
@layer utilities {
  ...
  .border-\[\#C7A45A\]\/30 {
    border-color: oklab(73.4781% .00969577 .101246 / .3);
  }
  ...
  .border-\[\#F37021\]\/30 {
    border-color: oklab(69.24% .125418 .130844 / .3);
  }
  ...
  .bg-\[\#F9F6F3\]\/50 {
    background-color: oklab(97.4615% .00194138 .00474846 / .5);
  }
  ...
  .text-\[\#2E1C10\]\/20 {
    color: oklab(24.6466% .0207911 .0286474 / .2);
  }
  ...
  .text-\[\#2E1C10\]\/50 {
    color: oklab(24.6466% .0207911 .0286474 / .5);
  }
  ...
  .text-\[\#2E1C10\]\/70 {
    color: oklab(24.6466% .0207911 .0286474 / .7);
  }
  ...
  .ring-\[\#D61C1C\]\/20 {
    --tw-ring-color: oklab(55.9868% .190788 .101228 / .2);
  }
  ...
  @media (hover: hover) {
    .hover\:border-\[\#C7A45A\]\/40:hover {
      border-color: oklab(73.4781% .00969577 .101246 / .4);
    }
  }
...
:root {
  ...
  --color-dark-brown: #2e1c10 !important;
  --color-cream-bg: #f9f6f3 !important;
  --color-brass-gold: #c7a45a !important;
  --color-primary: #d61c1c !important;
  --color-primary-hover: #b71616 !important;
  --color-primary-light: #d61c1c1a !important;
  --color-secondary: #f37021 !important;
  --color-secondary-hover: #d45e1a !important;
  --color-secondary-light: #f370211a !important;
  --color-accent: #c7a45a !important;
  --color-accent-hover: #b08f4a !important;
  --color-accent-light: #c7a45a1a !important;
  --background: #fff !important;
  --foreground: #2e1c10 !important;
  --muted: #f9f6f3 !important;
  --font-sans: "Pretendard Variable", -apple-system, BlinkMacSystemFont, "Apple SD Gothic Neo", "Segoe UI", "Malgun Gothic", "Noto Sans KR", sans-serif !important;
  ...
  --leading-relaxed: 1.75 !important;
...
:root {
  --font-size: 16px;
  --font-sans: "Pretendard Variable", -apple-system, BlinkMacSystemFont, "Apple SD Gothic Neo", "Segoe UI", "Malgun Gothic", "Noto Sans KR", sans-serif;
  --text-xs: .75rem;
  --text-sm: .875rem;
  --text-base: 1rem;
  --text-lg: 1.125rem;

...
exports.validateNicepayEnv = exports.getNicepayEnvConfig = exports.getPaymentProviderMode = void 0;
/**
...
exports.getPaymentProviderMode = getPaymentProviderMode;
/**
 * NICEPAY 환경별 설정 가져오기
 *
 ...
 */
const getNicepayEnvConfig = (mode) => {
...
exports.getNicepayEnvConfig = getNicepayEnvConfig;
/**
 * 환경 변수 검증
 *
 * 실제 NICEPAY 모드일 때 필수 값이 설정되어 있는지 확인
 */
const validateNicepayEnv = (mode) => {
    if (mode === "mock") {
        return; // Mock 모드는 검증 불필요
    }
    const config = (0, exports.getNicepayEnvConfig)(mode);
...
exports.validateNicepayEnv = validateNicepayEnv;

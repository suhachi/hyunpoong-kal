      ...
      <div className="max-w-md mx-auto p-4 space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-xs">모든 푸시 알림 활성화/비활성화</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-xs">받고 싶은 알림을 선택하세요</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <Label htmlFor="orderUpdates">주문 상태 알림</Label>
                <p className="text-xs text-gray-500">주문 접수, 조리, 배달 등</p>
              </div>
              <Switch
                id="orderUpdates"
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">이벤트, 할인 정보 등</p>
              </div>
              <Switch
                id="promotions"
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">리뷰 요청, 답글 등</p>
              </div>
              <Switch
                id="reviews"
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">포인트 적립, 만료 예정 등</p>
              </div>
              <Switch
                id="points"
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-xs">알림을 받을 때의 효과 설정</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
        ...
        {hasPermission && settings.enabled && (
          <Card>
            <CardHeader>
              ...
              <CardDescription className="text-xs">테스트 알림을 전송해보세요</CardDescription>
            </CardHeader>
            <CardContent>
              <Button className="w-full" variant="outline" onClick={handleTestNotification}>
                테스트 알림 보내기
              </Button>
            </CardContent>
          </Card>

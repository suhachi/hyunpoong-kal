...
export function DeliveryIcon({
  ...
  return (
    ...
    >
      ...
      {/* 왼쪽 핸들 그립 */}
      <circle cx="10" cy="12" r="2.5" fill="none" stroke="#2E1C10" strokeWidth="3" />

      {/* 오른쪽 핸들 그립 */}
      <circle cx="20" cy="12" r="2.5" fill="none" stroke="#2E1C10" strokeWidth="3" />
      ...
      {/* 바퀴 내부 원 */}
      <circle cx="15" cy="40" r="2" fill="none" stroke="#2E1C10" strokeWidth="2" />

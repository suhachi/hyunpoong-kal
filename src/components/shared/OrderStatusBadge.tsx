...
> = {
  // 기본 주문 상태
  [OrderStatus.PENDING]: { label: "접수대기", variant: "secondary" },
  [OrderStatus.ACCEPTED]: { label: "접수확인", variant: "default" },
  [OrderStatus.COOKING]: { label: "조리중", variant: "outline" },
  [OrderStatus.DELIVERING]: { label: "배달중", variant: "secondary" },
  [OrderStatus.COMPLETED]: { label: "완료", variant: "default" },
  [OrderStatus.CANCELLED]: { label: "취소", variant: "destructive" },

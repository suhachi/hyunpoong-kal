const HERO_IMAGE_URL =
  "https://images.unsplash.com/photo-1676686997059-fb817ebbb2b5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxrb3JlYW4lMjBub29kbGUlMjBzb3VwJTIwcmVzdGF1cmFudHxlbnwxfHx8fDE3NjE3MDQ1NDl8MA&ixlib=rb-4.1.0&q=80&w=1080";
      ...
      <div className="relative container mx-auto px-4 h-full flex items-center">
        <div className="text-white max-w-2xl">
          ...
          <p className="text-gray-200 mb-8 leading-relaxed">
            공정하고 바람직한 시장 환경 속에서 맛집답게도 가가 20년 동안 신의와 정성은 변함이
            없습니다
          </p>

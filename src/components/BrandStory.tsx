...
const BRAND_IDENTITY_URL =
  "https://images.unsplash.com/photo-1701009203098-3bab61afe474?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0cmFkaXRpb25hbCUyMGtvcmVhbiUyMHJlc3RhdXJhbnR8ZW58MXx8fHwxNzYxNzA0NTQ5fDA&ixlib=rb-4.1.0&q=80&w=1080";
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-700 max-w-3xl mx-auto">
            ...
            <br />
            ㈜지앤씨신칼은 2021년 사명을 변경하며, '칼국수의 대중화와 세계화'를 목표로
            <br />
